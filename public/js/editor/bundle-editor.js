...
editor.focus();
editor.setContents([{ insert: 'Chapter N - Title Could Come from Outline of Book', attributes: { size: "18px" } }, { insert: '\n\n\n' }]);

$('#save').on("click", function () {
	var contents = editor.getContents();
	superagent.post('/editor/456').send({ contents: contents }).end(function (err, res) {
