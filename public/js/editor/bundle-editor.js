	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'select',
					{ title: 'Text Color', className: 'ql-color' },
					React.createElement('option', { value: 'rgb(0, 0, 0)', label: 'rgb(0, 0, 0)', selected: '' }),
					React.createElement('option', { value: 'rgb(230, 0, 0)', label: 'rgb(230, 0, 0)' }),
					React.createElement('option', { value: 'rgb(255, 153, 0)', label: 'rgb(255, 153, 0)' }),
					React.createElement('option', { value: 'rgb(255, 255, 0)', label: 'rgb(255, 255, 0)' }),
					React.createElement('option', { value: 'rgb(0, 138, 0)', label: 'rgb(0, 138, 0)' }),
					React.createElement('option', { value: 'rgb(0, 102, 204)', label: 'rgb(0, 102, 204)' }),
					React.createElement('option', { value: 'rgb(153, 51, 255)', label: 'rgb(153, 51, 255)' }),
					React.createElement('option', { value: 'rgb(255, 255, 255)', label: 'rgb(255, 255, 255)' }),
					React.createElement('option', { value: 'rgb(250, 204, 204)', label: 'rgb(250, 204, 204)' }),
					React.createElement('option', { value: 'rgb(255, 235, 204)', label: 'rgb(255, 235, 204)' }),
					React.createElement('option', { value: 'rgb(255, 255, 204)', label: 'rgb(255, 255, 204)' }),
					React.createElement('option', { value: 'rgb(204, 232, 204)', label: 'rgb(204, 232, 204)' }),
					React.createElement('option', { value: 'rgb(204, 224, 245)', label: 'rgb(204, 224, 245)' }),
					React.createElement('option', { value: 'rgb(235, 214, 255)', label: 'rgb(235, 214, 255)' }),
					React.createElement('option', { value: 'rgb(187, 187, 187)', label: 'rgb(187, 187, 187)' }),
					React.createElement('option', { value: 'rgb(240, 102, 102)', label: 'rgb(240, 102, 102)' }),
					React.createElement('option', { value: 'rgb(255, 194, 102)', label: 'rgb(255, 194, 102)' }),
					React.createElement('option', { value: 'rgb(255, 255, 102)', label: 'rgb(255, 255, 102)' }),
					React.createElement('option', { value: 'rgb(102, 185, 102)', label: 'rgb(102, 185, 102)' }),
					React.createElement('option', { value: 'rgb(102, 163, 224)', label: 'rgb(102, 163, 224)' }),
					React.createElement('option', { value: 'rgb(194, 133, 255)', label: 'rgb(194, 133, 255)' }),
					React.createElement('option', { value: 'rgb(136, 136, 136)', label: 'rgb(136, 136, 136)' }),
					React.createElement('option', { value: 'rgb(161, 0, 0)', label: 'rgb(161, 0, 0)' }),
					React.createElement('option', { value: 'rgb(178, 107, 0)', label: 'rgb(178, 107, 0)' }),
					React.createElement('option', { value: 'rgb(178, 178, 0)', label: 'rgb(178, 178, 0)' }),
					React.createElement('option', { value: 'rgb(0, 97, 0)', label: 'rgb(0, 97, 0)' }),
					React.createElement('option', { value: 'rgb(0, 71, 178)', label: 'rgb(0, 71, 178)' }),
					React.createElement('option', { value: 'rgb(107, 36, 178)', label: 'rgb(107, 36, 178)' }),
					React.createElement('option', { value: 'rgb(68, 68, 68)', label: 'rgb(68, 68, 68)' }),
					React.createElement('option', { value: 'rgb(92, 0, 0)', label: 'rgb(92, 0, 0)' }),
					React.createElement('option', { value: 'rgb(102, 61, 0)', label: 'rgb(102, 61, 0)' }),
					React.createElement('option', { value: 'rgb(102, 102, 0)', label: 'rgb(102, 102, 0)' }),
					React.createElement('option', { value: 'rgb(0, 55, 0)', label: 'rgb(0, 55, 0)' }),
					React.createElement('option', { value: 'rgb(0, 41, 102)', label: 'rgb(0, 41, 102)' }),
					React.createElement('option', { value: 'rgb(61, 20, 102)', label: 'rgb(61, 20, 102)' })
				),
				React.createElement('span', { className: 'ql-format-separator' }),
				React.createElement('span', { title: 'Bold', className: 'ql-format-button ql-bold' }),
				React.createElement('span', { className: 'ql-format-separator' }),
				React.createElement('span', { title: 'Italic', className: 'ql-format-button ql-italic' }),
				React.createElement('span', { className: 'ql-format-separator' }),
				React.createElement('span', { title: 'Underline', className: 'ql-format-button ql-underline' }),
				React.createElement('span', { className: 'ql-format-separator' }),
...
},{"./editor-toolbar.js":15,"quill":2,"react-notification-system":7,"superagent":10}],17:[function(require,module,exports){
"use strict";
require('./editor.js');
require('./assets.js');
